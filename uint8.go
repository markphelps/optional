...
// NewUint8FromPointer creates an optional.Uint8 from a uint8 pointer.
func NewUint8FromPointer(v *uint8) Uint8 {
	if v == nil {
		return Uint8{}
	}
	return NewUint8(*v)
...
// ToPointer returns a *uint8 of the value or nil if not present.
func (u Uint8) ToPointer() *uint8 {
	if !u.Present() {
		return nil
	}
	v := *u.value
